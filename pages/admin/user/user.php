...
class AdminUserController extends AdminController{
            ...
            switch ($submitted){
                ...
                case "change_password":
                    ...
                    if ($password["PASSWORD"] != $password["PASSWORD2"] || 
                        ...
                        Utils::create_warning_message(_t(46));
                        Utils::create_warning_message(_t(47), "alert-warning" );
                    }else{
    ...
    private function insertUser(): bool{
        if(!$this->user->checkUsernameInsertAvailable()){
            Utils::create_warning_message(_t(42));
            return FALSE;
        }elseif (!$this->user->checkEmailInsertAvailable()) {
            Utils::create_warning_message(_t(41));
            return FALSE;
        }
        ...
        if($this->user->insert()){
            ...
            if(Utils::HTMLMail($email, $subject, $message, $username)){
                ...
                Utils::create_warning_message(_t(43));
            }
        }
        return FALSE;
    }
