  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="coreNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <?php if(User::get_current_core_user()->isAdmin()){
        ?><li><a href="<?php echo SITE_ROOT."/admin/manage"; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo _t(2); ?></a></li>
            <?php } ?>
        <li><a href="<?php echo SITE_ROOT."/admin/user"; ?>"><span class="glyphicon glyphicon-user"></span><?php $user = User::get_current_core_user(); echo $user->isLoggedIn() ? "$user->NAME $user->SURNAME": _t(115); ?></a></li>
