...
COMMIT;";
db_query($sql);
db_query("CREATE TABLE `CACHE` ( ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, `bundle` VARCHAR(255), `key` VARCHAR(255), `value` LONGTEXT) CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE=InnoDB;"); 
db_query("CREATE TABLE `VARIABLES` ( ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, `key` VARCHAR(255), `value` TEXT, UNIQUE (`key`) ) CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE=InnoDB;"); 