...
/* harmony default export */ __webpack_exports__["default"] = (window.moment=moment__WEBPACK_IMPORTED_MODULE_0___default.a);__webpack_require__(/*! tempusdominus-bootstrap-4 */ "./node_modules/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.js");$(function($){$(".timeinput").each(function(i,el){el=$(el);var default_value=el.val();el.val("");el.datetimepicker({format:"HH:mm",locale:language});el.val(default_value);});$(".dateinput").each(function(i,el){el=$(el);var default_value=el.val();el.val("");el.datetimepicker({format:"DD-MM-YYYY",locale:language});el.val(default_value);});$(".datetimeinput").each(function(i,el){el=$(el);var default_value=el.val();el.val("");el.datetimepicker({format:"DD-MM-YYYY HH:mm",locale:language});el.val(default_value);});});
